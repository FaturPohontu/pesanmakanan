    ...
    <div class="col shadow-sm">
        <a href="index.php?page=beli.php&id=1" class="text-decoration-none">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <h5 class="card-title">Rice Bowl Ayam</h5>
    ...
    <div class="col shadow-sm">
        <a href="index.php?page=beli.php&id=2" class="text-decoration-none">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <h5 class="card-title">Rice Bowl Sapi</h5>
    ...
    <div class="col shadow-sm">
        <a href="index.php?page=beli.php&id=3" class="text-decoration-none">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <h5 class="card-title">Rice Bowl Telur</h5>
...
<div class="d-flex justify-content-center mt-3">
    <button class="btn btn-primary w-50">Pesan Sekarang</button>
</div>
<br>
